...
while fortsett:
    ...
    """ --- Legger til poengene på skjermen ---"""
...
Malen har tatt utgangspunkt i Aschehough sitt løsningsforslag for høsten 2024



Kilder:

Her bruker jeg collideRect funksjonen. Denne er hentet fra biblioteket for pygaem. 
