...
#print(df["start_station_description"])

#print(df.start_station_description.unique())

#print(df[df["start_station_name"] == "Bislett Stadion"])

#print(df.iloc[0, 0])

hus = df.copy()
hus.set_index("start_station_name", inplace=True)

df.drop(start_station_id)
